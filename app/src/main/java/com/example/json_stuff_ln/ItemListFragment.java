...
import com.example.json_stuff_ln.databinding.FragmentItemListBinding;
import com.example.json_stuff_ln.databinding.ItemListContentBinding;

import com.example.json_stuff_ln.placeholder.PlaceholderContent;
...
public class ItemListFragment extends Fragment {
    ...
    {
        ModelContent displayMaker = new ModelContent();
        displayMaker.jsonParse( getActivity() );
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(ModelContent.MODELS, itemDetailFragmentContainer));
    }
    ...
    public static class SimpleItemRecyclerViewAdapter extends RecyclerView.Adapter<SimpleItemRecyclerViewAdapter.ViewHolder>
    {
        ...
        SimpleItemRecyclerViewAdapter(List<Model> items, View itemDetailFragmentContainer)
        {
            mValues = items;
        ...
        public void onBindViewHolder(final ViewHolder holder, int position)
        {
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
            {
                 ...
                 */
                holder.itemView.setOnContextClickListener(v -> {PlaceholderContent.PlaceholderItem item = (PlaceholderContent.PlaceholderItem) holder.itemView.getTag();
